      ...
      <div className="px-4 relative">
        <div className="relative z-20 w-max mx-auto">
          <div className="flex justify-center flex-col pt-4 gap-8">
            <div className="bg-white lg:min-w-[900px] md:min-h-max md:max-w-none max-w-md  md:p-2 pb-12 md:pr-10 shadow-sm shadow-light-blue rounded-md px-6 py-8 md:flex md:items-center md:gap-12 w-[720px]">
              <SideBarDesktop />
              <motion.div
                initial={{
                  opacity: 0,
